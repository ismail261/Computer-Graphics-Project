...
class cl_pannel_05:
    ...
    def __init__(self, master):
        ...
        for line in f:
            ...
            second = line[2:]
            if firstLetter == 'i':
                self.listbox.insert(END, second.rstrip())
        f.close()
        self.listbox.select_set(0)
    ...
    def fly_callback(self):
        ...
        self.master.ob_world.fly_image(self.master.ob_canvas_frame.canvas,self.listbox.get(self.listbox.curselection()),self.point.get(),self.point1.get(),self.steps.get())